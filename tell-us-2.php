...
$count_img    = mysqli_query($con,"SELECT * FROM task_img WHERE task_id='$task_id'"); 
$getimg_count = mysqli_num_rows($count_img);
?>
...
<div class="right">
   ...
   <a href="javascript:(0);" class="add-imgs add_draft" style="padding-top:5px;font-size:15px;">
   <i class="fa fa fa-file pr-1"></i>Draft</a> 

 
  <a class="add-imgs" href="add-img.php?cat=<?php echo $_GET['cat'];?>&task_id=<?php echo $_GET['task_id'];?>">
  <i class="fa fa-paperclip pr-3" style="transform: rotate(45deg);padding-top:3; padding-right:15px;position:relative;"></i> <span class="tot"><?php echo $getimg_count;?></span></a>
  
  <!-- <a class="add-imgs" href="#" style="padding-top:10px">
  <i class="fa fa fa-trash-o pr-3" style=""></i> <span class="tot">2</span></a> -->
...
<div class="" style="margin-top:7px"></div>
  ...
  <!----step-form-->
     <div class="col-12">
            ...
            <!--   <span class="text-info" style="color:#17a2b8 !important;"><a style="color:#17a2b8;" href="add-img.php"> <i class="fa fa-plus icost"></i> Add Must haves</a></span><br> -->
              ...
              <div class="row mt-3" id="locat">
               ...
               Task location (postcode)
                <input type="text" name="task_location" id="location" class="task_title mt-2 task_location" placeholder="City Name" autocomplete="off" onclick="mapaddressforcountry()">
              </div>  
                ...
                <br>
                 <div class="row">
                    ...
                    <label>when do you need it done?</label>
                      <input type="date" name="task_end" id="datepicker" min="<?php echo date('Y-m-d');?>" class="task_title task_end" placeholder="Select a date">
        ...
        <input type="checkbox" name="remember" id="remember" class="form-check-input remember" value="1"> <span style="width:unset;padding-left: 20px;"> I need a certain time of day </span>
             ...
             <div class="col-6 mb-2 mt-2">
               <div class="gallery-card">
                    <div class="gallery-card-body">
                     ...
                     <input type="radio" class="ck time_prefer" value="Morning (Before 10am)" name="time_prefer">
              ...
              <div class="col-6 mb-2 mt-2">
                 <div class="gallery-card">
                    ...
                    <input type="radio" class="ck time_prefer" value="Midday (10am - 2pm)" name="time_prefer">
                      <span class="checkmark"></span>
                      </label>
                       <div class="mycard-footer">
                       <h6>Midday</h6>
              ...
              <div class="col-6 mb-2 mt-2">
                <div class="gallery-card">
                    ...
                    <label class="block-check">
                      ...
                      <input type="radio" class="ck time_prefer" value="Afternoon (2pm - 6pm)" name="time_prefer">
                      <span class="checkmark"></span>
                      </label>
                      <div class="mycard-footer">
                        <h6>Afternoon</h6>
              ...
              <div class="col-6 mb-2 mt-2">
                  ...
                  <div class="gallery-card">
                    ...
                    <input type="radio" class="ck time_prefer" value="Evening (After 6pm)" name="time_prefer">
                      <span class="checkmark"></span>
                      </label>
                       <div class="mycard-footer">
                       <h6>Evening</h6>
      ...
      $radio.closest('.gallery-card') .css('background','#05a0c7');
        ...
        $("#remember").click(function () {
            ...
            <fieldset>
                ...
                <div class="buttongroup text-center input-group">  
                 ...
                 <div class="form-check-inline">
                      <label class="form-check-label" for="radio1">
                        <input type="radio" class="form-check-input task_type" id="radio1"  value="Fixed" name="task_type" checked="">Total
                      </label>
                    </div>
                    <div class="form-check-inline">
                      <label class="form-check-label" for="radio2">
                        <input type="radio" class="form-check-input task_type" id="radio2"  value="Hourly" name="task_type">Hourly rate
                      </label>
                    </div>
                </div>
              </div>
                ...
                <input type="number" name="budget" class="budget" placeholder="GBP" min="0" oninput="this.value = Math.abs(this.value)" style="text-align:center;min-height: 50px"/>
                </div>
                ...
                <div class="row hbudget" style="display:none;">
                    <div class="col-6">
                        <label>Hours</label>
                        <input type="number" name="hours" class="hours" min="1" oninput="this.value = Math.abs(this.value)" placeholder="Hours"/>
                    ...
                    <div class="col-6">
                        ...
                        <input type="number" name="hourly_budget" class="hourly_budget" min="0" oninput="this.value = Math.abs(this.value)" placeholder="GBP"/>
...
//signup 
    ...
    $.ajax({type: "POST", url: "controller/api/add_draft.php",dataType: "json",
    ...
    // $(".succpost").html("<p>"+data.response+"</p>");
    //window.location = 'tasks-details.php?task_id='+data.task_id;
    window.location = 'my-task.php?val=drafft&tab=booking';
