...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $sqls    = "SELECT * FROM account WHERE email_address='$email'";
    ...
    $link = 'https://sharukh.dbtechserver.online/betasker/upd_pass.php?id='.$uid;
...
<body class='clean-body' style='margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #f9f9f9'>
                                                    ...
                                                    <tr>
                                                        <td style='overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;' align='left'>
                                                            ...
                                                            <div style='color: #000000;background-color:#e8faff;line-height: 160%; text-align: center; word-wrap: break-word;'>
                                                                ...
                                                                <p style='font-size: 14px; line-height: 160%;'><span style='font-size: 18px; line-height: 28.8px;'>  Your Password Reset Link is Here. <br> $link </span></p>
   ...
   // mail function end
      ...
      $response = array(
        ...
        "status"   => "success",
        "count"    => $count,
        "response" => "Successfully sent link by mail!"
          ...
          $response = array(
                      "err" => "error",
                    "response" => "Email is does not exist!"
