...
date_default_timezone_set("Asia/Kolkata");
    ...
    $sql3   = mysqli_query($con,"SELECT * FROM review WHERE task_id='$task_id' AND is_from='poster'");
  ...
  if($rate < 0){
      ...
      $response = array(
        ...
        $sql = mysqli_query($con,"INSERT INTO review(date,time,creator,receiver,rate,review,task_id,task_done_per) VALUES('$date','$time','$creator','$receiver','$rate','$review','$task_id','$task_done_per')");



         $sql2 = mysqli_query($con,"UPDATE task_create SET status='close',task_close='$date' WHERE task_id='$task_id'");
         $sql3 = mysqli_query($con,"UPDATE task_award SET is_close='1' WHERE task_id='$task_id' AND task_creator='$creator'");
