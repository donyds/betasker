...
$update  = mysqli_query($con,"UPDATE task_apply SET status='2' WHERE id='$proposal_id'");

$get_p = mysqli_query($con,"SELECT * FROM task_apply WHERE id='$proposal_id'");

$pdata = mysqli_fetch_array($get_p);

$task_receiver = $pdata['account_id'];
...
<p style='font-size: 14px; line-height: 160%;'><span style='font-size: 18px; line-height: 28.8px;'>  Your  proposal request is Decline. <br> </span></p>
