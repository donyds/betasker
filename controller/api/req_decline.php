...
$sqls    = "UPDATE chat_req_pay SET status='2',title='Decline' WHERE id='$id'";
$results  = mysqli_query($con,$sqls);
$stamp    = date('Y-m-d H:i:s');
$uname    = $_COOKIE['username']; 
$message  = $uname." Has  €".$amount." Amount  Request Decline";
...
$mail->Subject = "Paymeny Request Decline";
...
<p style='font-size: 14px; line-height: 160%;'><span style='font-size: 18px; line-height: 28.8px;'> Someone Has Paymeny Request Decline<br> </span></p>
...
// header('Location: ../../req_list_creator.php?chat='.$chatsid.'&succ');
