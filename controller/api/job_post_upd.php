...
date_default_timezone_set("Asia/Kolkata");
  ...
  if(empty($task_title)){
    ...
    $sql = mysqli_query($con,"UPDATE task_create SET date='$date',time='$time',task_title='$task_title',task_description='$task_description',task_type='$task_type',task_location='$task_location',task_budget='$task_budget',task_end='$task_end',time_prefer='$time_prefer',task_currency='€',task_hour='$task_hour',timestamp='$currnt_time',status='runing',task_status='1' WHERE task_id='$task_id'");
