...
$account_id = mysqli_escape_string($con,$_POST['account_id']);
...
$email    = $udetails['email_address'];
$wallet   = $udetails['wallet'];
$username = explode(" ", $udetails['fullname']);
$username = $username[0];
$total_bal= $wallet + $amount ;



$update = mysqli_query($con,"UPDATE payment_transaction SET status='accept' WHERE transaction_id='$orderid'");
...
<p style='font-size: 14px; line-height: 140%;'><span style='font-size: 28px; line-height: 39.2px;'><strong><span style='line-height: 39.2px; font-size: 28px;'>Add Amount</span></strong>
</span>
</p>
</div>
...
<p style='font-size: 14px; line-height: 160%;'><span style='font-size: 18px; line-height: 28.8px;'>You have Successfully Add £$link in Your wallet. <br> </span></p>
