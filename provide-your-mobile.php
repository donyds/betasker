...
$check   = mysqli_query($con,"SELECT * FROM account WHERE account_id ='$cookie_id'");
...
<div class="title pt-1 pl-2"><span class="subtitle"><h6>Mobile verification</h6></span></div>
...
<div class="" style="margin-top:40px"></div>
  ...
  <form id="" method="post" action="controller/api/mobile_upd.php" autocomplete="off">
...
<div class="col-12 ">
  <div class="form-group">
        ...
        <input type="number" value="<?php echo $already['mobile_no'];?>" class="form-control w-100" id="number" placeholder="" name="mobile_no" required="">
    </div>
 </div> 
...
<button type="submit" name="submit" class="col button button-large button-round button-fill w-75 mx-auto text-white btn-success text-capitalize submitsignup" style="font-size: 20px;background:#91d18b;min-height:40px;font-weight:600;border-radius: 20px;
    padding: 5px 10px;">Send verification code</button>
