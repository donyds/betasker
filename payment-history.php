...
<div class="title pt-1 pl-2"><span class="subtitle"><h6>Payment history</h6></span></div>
...
<div class="row d-flex" style="align-content:center;" style="margin-right:0px!important;margin-left:0px!important;"> 
          ...
          <div class="col-8">
               <h4 style="font-size: 18px;"><?php echo $row->title;?></h4>
...
<div class="row d-flex" style="align-content:center;" style="margin-right:0px!important;margin-left:0px!important;"> 
          ...
          <div class="col-8">
               <h4 style="font-size: 18px;"><?php echo $val->title;?></h4>
